...
import (
	...
	apiserver "github.com/cresendoo/decidash-backend/internal/application/api-server"
...
func main() {
	...
	logger := xlogger.Build(
		...
		xlogger.WithNamespace("api-server"),
	...
	app, err := apiserver.NewApplication(ctx, logger, &cfg)
	if err != nil {
